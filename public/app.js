...
const hi = L.marker([48.871282159004856, 2.3635818588892714],{icon: myIcon}).bindPopup('SUP JONATHAN')

const stations = L.layerGroup([rS, sSD, sentier, bourse, qS, gB, hi]).addTo(myMap)
